...
contains
 ...
 !> Extract the coordinates in a DFTB+ calculation instance -------------------------------------------------------- Barnali
 function c_DftbPlus_getCoords(handler) result(coords) bind(C, name='dftbp_get_coords')
         ...
         call c_f_pointer(handler%instance, instance)
         nAtom = instance%nrOfAtoms()
         call instance%getGeometry(coords(:, 1:nAtom))

 end function c_DftbPlus_getCoords
