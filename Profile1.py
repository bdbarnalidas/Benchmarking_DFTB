...
Input_method = 'DC'  # The eigensolver routine present in the input file
Iteration_count = 1  # Number of times for profiling the source code w.r.t. the same input file
Result_directory = 'nb_1/'
Input_list = 'Input.txt'  # The file containing the list of molecules for which you want to run your simulation
write_file1 = 'time.txt'
fp_write1 = open(write_file1, "w")
...
def profile_dftb(molname):
    ...
    for i in range(0, Iteration_count):
        ...
        os.system(run_dftb)
        end_time = time.time()
        fp_write1.write(molname + '\t' + str(end_time - start_time) + '\n')
